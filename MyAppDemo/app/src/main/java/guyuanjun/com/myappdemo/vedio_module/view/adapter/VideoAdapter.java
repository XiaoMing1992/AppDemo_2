package guyuanjun.com.myappdemo.vedio_module.view.adapter;
...
/*        Picasso.with(mContext).load(item.getCover()).fit().placeholder(R.drawable.ic_loading).error(R.drawable.ic_fail)
                .into(imageView);*/
