...
import guyuanjun.com.myappdemo.fragment.my.store.music.business.lyric.qq.QQLyricHelper;
...
public class LyricDownloadService extends IntentService
{
	...
	{
		super(name);
		mDownloadTask = new ArrayList<DownloadTask<Music, ResultReceiver>>();
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		synchronized (mLock)
		{
			...
			DownloadTask<Music, ResultReceiver> task = new DownloadTask<Music, ResultReceiver>(
					music, receiver);
