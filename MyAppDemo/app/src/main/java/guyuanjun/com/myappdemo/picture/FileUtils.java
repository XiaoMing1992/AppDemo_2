...
public class FileUtils {
	...
	public static final String WEITOUTIAOPATH = "weitoutiao/";

	public static void saveBitmap(Bitmap bm, String dirName, String picName) {
		Log.e("saveBitmap", "保存图片");
		try {
			if (!isDirExist(dirName)) {
				File tempf = createSDDir(dirName);
			}
