...
public class PushInfoDao extends AbstractDao<PushInfo, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, PushInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PushInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(PushInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PushInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PushInfo entity) {
