package guyuanjun.com.myappdemo.vedio_module.api;
...
public class ApiManager {
    ...
    private static File httpCacheDirectory = new File(MainApplication.getContext().getExternalCacheDir(), "newsCache");
