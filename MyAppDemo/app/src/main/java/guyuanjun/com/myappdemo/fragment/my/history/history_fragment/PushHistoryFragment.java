...
import guyuanjun.com.myappdemo.adapter.PushHistoryAdapter;
...
public class PushHistoryFragment extends Fragment {
    private final String TAG = PushHistoryFragment.class.getSimpleName();

    private RecyclerView push_list;
            ...
            switch (msg.what){
                ...
                case LoadCode.SUCCESS:
                    ...
                    if (newsItemInfoList.isEmpty()) {
                        ...
                        adapter = new PushHistoryAdapter(getActivity(), newsItemInfoList);
                        push_list.setAdapter(adapter);
                        listener();
                    }
                    break;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myLayout = inflater.inflate(R.layout.push_history, container, false);
        initView();
    ...
    private void initView(){
        push_list = (RecyclerView) myLayout.findViewById(R.id.push_history_list);
        ...
        * */
        push_list.setLayoutManager(new LinearLayoutManager(getActivity()));
        //设置item之间的间隔
        SpacesItemDecoration spacesItemDecoration = new SpacesItemDecoration(20);
        push_list.addItemDecoration(spacesItemDecoration);
...
/*        //封装的okhttp工具类的get异步
    ...
    private void listener(){
        adapter.setmOnItemClickListener(new PushHistoryAdapter.OnItemClickListener() {
            @Override
        ...
        //长按监听
        adapter.setmOnItemLongClickListener(new PushHistoryAdapter.OnItemLongClickListener() {
            @Override
    ...
    private String testDatas(){
        List<NewsItemInfo> newsItemInfoList = NewsItemInfoDaoOpe.getInstance().queryAll(getActivity());
