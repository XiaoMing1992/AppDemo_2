...
public class PushHistoryAdapter extends RecyclerView.Adapter<PushHistoryAdapter.AdapterViewHolder> {
    private final String TAG = "PushHistoryAdapter";

    private List<NewsItemInfo> mDatas;
    private Context mContext;

    public PushHistoryAdapter(Context context, List<NewsItemInfo> datas) {
        mDatas = datas;
        mContext = context;
    }
    ...
    public AdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.push_history_item, parent, false);
